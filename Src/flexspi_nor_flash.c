                    ...
                    serial_nor_config_option_t *option)
{
    ...
    do
    {
        ...
        if (option->option0.B.device_type == kSerialNorCfgOption_DeviceType_ReadSFDP_DDR)   //const
        {
                                                      ...
                                                      serial_nor_config_option_t *option)
{
    ...
    do
    {
        if (option->option0.B.query_pads != FLEXSPI_1PAD)       //如果query pad不是一根线，直接退出，必须等于1
        {
            break;
        }
